...
export class HyperX_Device_Protocol {
	...
	getDeviceImage(deviceName) { return HyperXdeviceLibrary.imageLibrary[deviceName]; }
...
export class deviceLibrary {
	constructor(){
		...
		this.imageLibrary = {
			"Pulsefire Haste 2":		"https://assets.signalrgb.com/devices/brands/hyperx/mice/pulsefire-haste-2.png",
			"Pulsefire Haste 2 Mini":	"https://assets.signalrgb.com/devices/brands/hyperx/mice/pulsefire-haste-2-mini.png",
		};
	}
}
